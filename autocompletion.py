...
class AutocompleteEntry(Entry):
    def __init__(self,win,lista,toplevel=True,*args, **kwargs):
        self.window=win
        self.toplevel=toplevel
        Entry.__init__(self,win,*args,**kwargs)
        self.lista = lista        
            ...
            if words:            
                if not self.lb_up:
                    if self.toplevel == True :
                        ...
                        #self.lb.place(x=self.winfo_x()+self.window.winfo_x(), y=self.winfo_y()+self.winfo_height()+self.window.winfo_y())
                        self.lb.place(x=self.winfo_x(), y=self.winfo_y()+self.winfo_height())

                        self.lb_up = True
                    else:
                        self.lb = Listbox(self.window.master)
                        self.lb.bind("<Double-Button-1>", self.selection)
                        self.lb.bind("<Right>", self.selection)
                        self.lb.place(x=self.winfo_x()+self.window.winfo_x(), y=self.winfo_y()+self.winfo_height()+self.window.winfo_y())
                        #self.lb.place(x=self.winfo_x(), y=self.winfo_y()+self.winfo_height())
...
if __name__ == '__main__':
    ...
    entry = AutocompleteEntry(win=root,lista=lista,width=50)
